...
// Il codice della classe seguente deriva dal progetto: https://github.com/tequilarapido/letter-avatar
// Un'alterantiva è https://github.com/laravolt/avatar
// Altra alternativa client-side: https://github.com/uttesh/ngletteravatar  http://uttesh.com/ngletteravatar/
// Oppure: http://judelicio.us/initial.js/
...
// USAGE
//$letter = "B";
//$dataUri = $letterAvatar
//->setFontFile('/../fonts/OpenSans-Regular.ttf')
//->setTextColor([255, 0, 0])
//->setBackgroundColors([255, 0, 0], [0, 255, 0], [0, 0, 255])
//->generate($letter, 120) // max size is 240
//->getPngAsBase64();
...
class LetterAvatar
{
    ...
    public function getPngAsBase64($quality=9){ // quality = Compression level: from 0 (no compression) to 9.
