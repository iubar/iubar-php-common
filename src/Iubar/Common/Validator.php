...
class Validator extends BaseClass {
	...
	public static $regex_email = "/^([a-z0-9_\.-]+)@([\da-z\.-]+)\.([a-z\.]{2,6})$/i";
	...
	public static $toponimi = array("via", "v.", "viale", "v.le", "piazza", "piazzale", "piazzetta", "p.zza", "p.za", "p.le", "p.tta", "banchina", "strada", "str.", "st.", "vicolo", "arco", "largo", "l.go", "corso", "cso", "c.so", "galleria", "borgo", "passo", "località");
	...
	public function setLocaleIt(){
		$locale_array = array('it_IT.UTF-8', 'it_IT@euro', 'it_IT', 'italian');
	...
	public static function isAValidDmlQuery($query){
		$commands = array("INSERT ", "UPDATE ", "SELECT ", "DELETE ");
		return self::isAValidQuery($query, $commands);
	}
...
// 			}
		...
		public static function isPec($email){  // Metodo non utilizzato. Per utilizzi futuri !!!
			$b = false;
			$email = Formatter::cleanEmail($email);
			$patterns = array("legalmail.it", "pec.it", "pec.com", "consulentidellavoropec.it", "@pec.");
		...
		public static function isAlphabetical($str){ // TODO: testare il metodo con la stringa "Cantù" quando questa proviene da file in formato ANSI o da file in formato UTF-8. Sembrano esserci differenze								 
